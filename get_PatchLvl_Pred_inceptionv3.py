...
f = open('features/'+dbname+'_macroArch_'+suffix+'_lr_rop_epoch50_net_trainset_smx_predictions.txt', 'w')
...
###########################################################################
f = open('features/'+dbname+'_macroArch_'+suffix+'_lr_rop_epoch50_net_valset_smx_predictions.txt', 'w')
